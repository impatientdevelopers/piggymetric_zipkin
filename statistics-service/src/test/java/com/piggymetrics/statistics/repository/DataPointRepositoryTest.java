...
public class DataPointRepositoryTest {
	...
	public void shouldSaveDataPoint() {
		...
		List<DataPoint> points = repository.findByPointIdAccount(pointId.getAccount());
		assertEquals(1, points.size());
		assertEquals(pointId.getDate(), points.get(0).getPointId().getDate());
